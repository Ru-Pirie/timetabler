...
const { removeMember, addMember, getMembers } = require('../../../util/database');
...
module.exports = {
	...
	async execute(client, message, args) {
		...
		// addTimetable(args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7]);
	},
};